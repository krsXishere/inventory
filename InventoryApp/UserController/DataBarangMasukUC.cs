...
{
    public partial class DataBarangMasukUC : UserControl
    {
        Helper helper = new Helper();
        public DataBarangMasukUC()
        {
            InitializeComponent();
        }
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            ...
            DataSet dataLog = helper.GetData("select id_barang, nama_user, kode_barang, nama_barang, status_barang, stok_barang, kondisi_barang, tanggal_barang from barang, users where barang.id_user = users.id_user and status_barang='Masuk' and tanggal_barang='" + dateTimePicker1.Text + "'");
