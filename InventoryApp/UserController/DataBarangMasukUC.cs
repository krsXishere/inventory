...
namespace InventoryApp.UserController
{
    public partial class DataBarangMasukUC : UserControl
    {
        ...
        {
            DataSet data = helper.GetData("select id_log_barang, kode_barang, nama_barang, status_barang, stok_barang, kondisi_barang, tanggal_barang from log_barang where status_barang='Masuk' and (nama_barang like '%" + txtSearch.Text + "%' or kode_barang like '%" + txtSearch.Text + "%')");
