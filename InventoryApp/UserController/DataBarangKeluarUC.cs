...
namespace InventoryApp.UserController
{
    public partial class DataBarangKeluarUC : UserControl
    {
        ...
        public void DataBarangKeluarUC_Load(object sender, EventArgs e)
        {
            ...
            DataSet dataBarang = helper.GetData("select id_log_barang, kode_barang, nama_barang, status_barang, stok_barang, kondisi_barang, tanggal_barang from log_barang where status_barang='Keluar' and tanggal_barang='"+theDate+"'");
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            ...
            DataSet dataLog = helper.GetData("select id_log_barang, kode_barang, nama_barang, status_barang, stok_barang, kondisi_barang, tanggal_barang from log_barang where status_barang='Keluar' and tanggal_barang='" + theDate + "'");
